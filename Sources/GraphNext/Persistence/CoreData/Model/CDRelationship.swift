...
@objc(CDRelationship)
public final class CDRelationship: NSManagedObject {
    @nonobjc public class func fetchRequest() -> NSFetchRequest<CDRelationship> {
        return NSFetchRequest<CDRelationship>(entityName: "CDRelationship")
    }

    // MARK: - Attributi (derivati da Model.xcdatamodel)
    @NSManaged public var id: UUID                       // UUID (non-optional)
    @NSManaged public var type: String                   // String (non-optional)

    // Endpoints
    @NSManaged public var from: UUID?                    // UUID (optional)
    @NSManaged public var to: UUID?                      // UUID (optional)
